...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    async function fetchAll() {
      ...
      try {
        ...
        setVisitantes(Array.isArray(p) ? p : []);
        setPertences(Array.isArray(pe) ? pe : []);
        setOrgaos(Array.isArray(o) ? o : []);
        setEfetivos(Array.isArray(e) ? e : []);
      } catch (error) {
  ...
  // Estatísticas principais - com verificações de segurança
  ...
  // Estatísticas de visitas por estado - com verificações de segurança
  ...
  const chartData = dias.map((d) => {
    ...
    const count = Array.isArray(visitas) ? visitas.filter(v => {
      ...
      <DashboardLayout>
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">
                  Visão geral completa do sistema - Acesso total
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Efetivos Ativos</CardTitle>
                <UserCheck className="h-4 w-4 text-purple-600" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-purple-600">{loading ? '...' : totalEfetivos}</div>
                <p className="text-xs text-muted-foreground">
                  {totalOrgaos} órgãos cadastrados
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Dados gerais e estatísticas do sistema
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold">{Array.isArray(visitas) ? visitas.length : 0}</span>
                </div>
                <div className="flex items-center justify-between">
